...
if __name__ == '__main__':
    ...
    if vote:
        if is_wiki:
            ...
            ensemble = Ensemble(min_order, max_order, learn_fam=pred_fam, corpus='gutenberg')
            ensemble.train(train_data)
        ...
        if is_wiki:
            ...
            lms = lm.get_language_models(orders, 1, pred_fam, train_data, True, corpus='gutenberg')
    ...
    if is_wiki:
        ...
        tools.write_pred(y_pred, gold_labels, (sys.argv[1] + '_1'))
